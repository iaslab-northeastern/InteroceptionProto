...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => "git@github.com:biobeats/HANAudioEngine.git", :tag => '1.3.0' }
  s.social_media_url = 'http://www.biobeats.com'
  s.platform     = :ios, '7.0'
  s.requires_arc = true
  s.source_files = ['*.pd','engineabs/*.pd','roblib/*.{pd,wav}','instruments/*/*.wav', 'rjbsb/*.{pd,txt}','fluid/*.{pd,txt}','HAN_engineabs/*.{pd}']
